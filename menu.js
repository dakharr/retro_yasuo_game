function createSceneMenu()
{
    ...
    // Voir Nico
    // var spPanneau = new BABYLON.SpriteManager("spPanneau", "resources/pancarte.png", 2, 128, scene, 0.01, BABYLON.Texture.NEAREST_SAMPLINGMODE);
    ...
    textPaper.fontSize = "6%";
    textPaper.top = 0;
    textPaper.paddingRight = "22%";
    ...
    scene.registerAfterRender(function()
    {
        ...
        if(tpTrigger && tpTrigger2 && !drawPaperTrigger && tpTimer < Date.now())
        {
            ...
            textPaper.text = "DJ Sona concert \nis the place to be !";
